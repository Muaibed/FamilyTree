...
async function getData(): Promise<Person[]> {
  ...
  allPersons.forEach(person => {
    let personFormatted:Person = {id:`${person.id}`, name:person.firstName, familyName:person.familyName, gender:person.gender, childrenIds:[], spouses:person.spouseConnections.map(p => `${p.spouseId}`)};
