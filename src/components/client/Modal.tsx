...
export function PersonModal({
  ...
  return (
    <div
      className={`bg-card text-card-foreground border-t-[0.3em] p-[0.5em] rounded-xl md:rounded-lg w-full relative shadow-xl overflow-x-hidden ${gender === "MALE" ? "border-t-male" : gender === "FEMALE" ? "border-t-female" : "border-t-card"} `}
    >
      <Button
        onClick={onClose}
